...
struct PlayView: View {
    ...
    var body: some View {
        PlayShape()
            .fill(Color("ShadowColor").opacity(0.9))
            ...
            .strokeStyle(cornerRadius: size)
            .shadow(color: Color("ShadowColor").opacity(0.2), radius: 30, y: 30)
            .overlay {
                Text("12:08")
                    .font(.footnote)
                    .fontWeight(.semibold)
...
fileprivate struct PlayShape: Shape {
